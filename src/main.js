...
canvas.addEventListener("click", function(e) {
    ...
    const easternEgg = document.querySelector('#easternEgg');
    easternEgg.classList.add('z-30');
    easternEgg.classList.remove('hidden');
})

document.querySelector('#endEasternEgg').addEventListener('click', function(e) {
    counter = 1
    const easternEgg = document.querySelector('#easternEgg');
    easternEgg.classList.remove('z-30');
    easternEgg.classList.add('hidden');
})